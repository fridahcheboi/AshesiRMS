...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(32, 77);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(33, 127);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(32, 178);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(33, 226);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(107, 23);
			this->button4->TabIndex = 3;
			this->button4->Text = L"Update Profile";
			this->button4->UseVisualStyleBackColor = true;
			// 
			// listBox1
			// 
			this->listBox1->FormattingEnabled = true;
			this->listBox1->Location = System::Drawing::Point(203, 104);
			...
			this->label1->Location = System::Drawing::Point(200, 77);
			...
			this->ClientSize = System::Drawing::Size(483, 418);
